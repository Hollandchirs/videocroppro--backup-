...
export default function ResizeVideoForLinkedInPage() {
  return (
    <SubPageLanding
      h1="Resize Video for LinkedIn"
      h1Highlight="— Free Online"
      subtitle="Crop videos to 1:1 square or 16:9 landscape for LinkedIn posts and ads. AI face detection, no signup."
      ...
      internalLinks={[
        ...
        { href: "/crop-video-for-twitter", label: "Crop video for X/Twitter" },
