...
export default function CropVideoForInstagramReelsPage() {
  return (
    <SubPageLanding
      h1="Crop Video for Instagram Reels"
      h1Highlight="— Free Online"
      subtitle="Resize any video to 9:16 for Instagram Reels. AI face detection keeps people centered. No signup, no watermark."
      ...
      internalLinks={[
        ...
        { href: "/crop-video-for-youtube-shorts", label: "Crop video for YouTube Shorts" },
