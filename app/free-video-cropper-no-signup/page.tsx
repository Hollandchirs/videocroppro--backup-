...
export default function FreeVideoCropperNoSignupPage() {
  return (
    <SubPageLanding
      h1="Free Video Cropper"
      h1Highlight="— No Signup Required"
      subtitle="Crop and resize videos for any social platform. No account, no watermark, no upload to servers. Just open and edit."
